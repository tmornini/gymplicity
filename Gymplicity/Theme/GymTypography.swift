...
enum GymFont {
    ...
    /// 22pt bold rounded
    static let heading2 = Font.system(size: 22, weight: .bold, design: .rounded)
    /// 17pt semibold rounded
    static let heading3 = Font.system(size: 17, weight: .semibold, design: .rounded)
    /// 17pt semibold rounded
    ...
    static let bodyMono = Font.system(size: 17, weight: .medium, design: .rounded)
        .monospacedDigit()
    /// 13pt medium rounded
    ...
    static let numericEntry = Font.system(size: 44, weight: .bold, design: .rounded)
        .monospacedDigit()
    /// 32pt bold rounded mono — smaller numeric fields
    static let numericEntrySmall = Font.system(size: 32, weight: .bold, design: .rounded)
        .monospacedDigit()
}
